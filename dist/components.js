...
P(b,Element.prototype,{C:W,append:X});Y(b,{I:Z,H:aa,K:ba,remove:ca});}function Y(b,a){var d=Element.prototype;d.before=function(d){
var arguments$1 = arguments;
for(var f=[],e=0;e<arguments.length;++e){ f[e-0]=arguments$1[e]; }e=f.filter(function(b){return b instanceof Node&&g(b)});a.I.apply(this,f);for(var c=0;c<e.length;c++){ b.a(e[c]); }if(g(this)){ for(e=0;e<f.length;e++){ c=f[e],c instanceof Element&&b.b(c); } }};d.after=function(d){
var arguments$1 = arguments;
for(var f=[],e=0;e<arguments.length;++e){ f[e-0]=arguments$1[e]; }e=f.filter(function(b){return b instanceof Node&&
g(b)});a.H.apply(this,f);for(var c=0;c<e.length;c++){ b.a(e[c]); }if(g(this)){ for(e=0;e<f.length;e++){ c=f[e],c instanceof Element&&b.b(c); } }};d.replaceWith=function(d){
var arguments$1 = arguments;
for(var f=[],e=0;e<arguments.length;++e){ f[e-0]=arguments$1[e]; }var e=f.filter(function(b){return b instanceof Node&&g(b)}),c=g(this);a.K.apply(this,f);for(var u=0;u<e.length;u++){ b.a(e[u]); }if(c){ for(b.a(this),e=0;e<f.length;e++){ c=f[e],c instanceof Element&&b.b(c); } }};d.remove=function(){var d=g(this);a.remove.call(this);d&&b.a(this);};}function da(b){function a(a,
...
function(a){var d=g(a),f=C.call(this,a);d&&b.a(a);return f});m(Node.prototype,"replaceChild",function(a,c){if(a instanceof DocumentFragment){var d=Array.prototype.slice.apply(a.childNodes);a=R.call(this,a,c);if(g(this)){ for(b.a(c),c=0;c<d.length;c++){ b.b(d[c]); } }return a}var d=g(a),e=R.call(this,a,c),k=g(this);k&&b.a(c);d&&b.a(a);k&&b.b(a);return e});E&&E.get?a(Node.prototype,E):b.s(function(b){a(b,{enumerable:!0,configurable:!0,get:function(){
var this$1 = this;
for(var a=[],b=0;b<this.childNodes.length;b++){ a.push(this$1.childNodes[b].textContent); }
return a.join("")},set:function(a){
var this$1 = this;
for(;this.firstChild;){ C.call(this$1,this$1.firstChild); }y.call(this,document.createTextNode(a));}});});}function ea(b){m(Document.prototype,"createElement",function(a){if(this.__CE_hasRegistry){var d=b.f(a);if(d){ return new d.constructor }}a=z.call(this,a);b.g(a);return a});m(Document.prototype,"importNode",function(a,d){a=fa.call(this,a,d);this.__CE_hasRegistry?b.c(a):b.l(a);return a});m(Document.prototype,"createElementNS",function(a,d){if(this.__CE_hasRegistry&&(null===
a||"http://www.w3.org/1999/xhtml"===a)){var c=b.f(d);if(c){ return new c.constructor }}a=ga.call(this,a,d);b.g(a);return a});P(b,Document.prototype,{C:ha,append:ia});}function P(b,a,d){a.prepend=function(a){
var arguments$1 = arguments;
for(var c=[],e=0;e<arguments.length;++e){ c[e-0]=arguments$1[e]; }e=c.filter(function(a){return a instanceof Node&&g(a)});d.C.apply(this,c);for(var k=0;k<e.length;k++){ b.a(e[k]); }if(g(this)){ for(e=0;e<c.length;e++){ k=c[e],k instanceof Element&&b.b(k); } }};a.append=function(a){
var arguments$1 = arguments;
for(var c=[],e=0;e<arguments.length;++e){ c[e-
0]=arguments$1[e]; }e=c.filter(function(a){return a instanceof Node&&g(a)});d.append.apply(this,c);for(var k=0;k<e.length;k++){ b.a(e[k]); }if(g(this)){ for(e=0;e<c.length;e++){ k=c[e],k instanceof Element&&b.b(k); } }};}function ja(b){window.HTMLElement=function(){function a(){var a=this.constructor,c=b.L(a);if(!c){ throw Error("The custom element being constructed was not registered with `customElements`."); }var f=c.constructionStack;if(!f.length){ return f=z.call(document,c.localName),Object.setPrototypeOf(f,a.prototype),
...
a&&!a.indexOf("/")&&(a=(location.origin||location.protocol+"//"+location.host)+a);var d=e.response||e.responseText;304===e.status||!e.status||200<=e.status&&300>e.status?b(d,a):c(d);};e.send();} }else { c("error: href must be specified"); }}},v=/Trident/.test(navigator.userAgent)||/Edge\/\d./i.test(navigator.userAgent);h.prototype.f=function(a){
var this$1 = this;
a=a.querySelectorAll("link[rel=import]");for(var b=0,c=a.length;b<c;b++){ this$1.i(a[b]); }};h.prototype.i=function(a){var b=this,c=a.href;if(void 0!==this.a[c]){var d=this.a[c];
...
"data:text/javascript;charset=utf-8,"+encodeURIComponent(n.textContent+("\n//# sourceURL="+b+(d?"-"+d:"")+".js\n"))),n.textContent="",d++); }return a};h.prototype.j=function(){var a=this;if(!this.b){this.c.disconnect();this.flatten(document);var b=!1,c=!1,d=function(){c&&b&&(a.c.observe(document.head,{childList:!0,subtree:!0}),a.l());};this.u(function(){c=!0;d();});this.s(function(){b=!0;d();});}};h.prototype.flatten=function(a){
var this$1 = this;
a=a.querySelectorAll("link[rel=import]");for(var b={},c=0,d=a.length;c<d&&
(b.n=a[c]);b={n:b.n},c++){var e=this$1.a[b.n.href];(b.n.import=e)&&e.nodeType===Node.DOCUMENT_FRAGMENT_NODE&&(this$1.a[b.n.href]=b.n,b.n.readyState="loading",b.n.import=b.n,Object.defineProperty(b.n,"baseURI",{get:function(a){return function(){return a.n.href}}(b),configurable:!0,enumerable:!0}),this$1.flatten(e),b.n.appendChild(e));}};h.prototype.s=function(a){function b(e){if(e<d){var f=c[e],n=document.createElement("script");f.removeAttribute("import-dependency");for(var g=0,h=f.attributes.length;g<h;g++){ n.setAttribute(f.attributes[g].name,
...
--c||a();}}(f)),e&&f.h.parentNode!==document.head){var h=document.createElement(f.h.localName);h.__appliedElement=f.h;h.setAttribute("type","import-placeholder");f.h.parentNode.insertBefore(h,f.h.nextSibling);for(h=d(f.h);h&&d(h);){ h=d(h); }h.parentNode!==document.head&&(h=null);document.head.insertBefore(f.h,h);f.h.removeAttribute("type");}} }else { a(); }};h.prototype.l=function(){
var this$1 = this;
for(var a=document.querySelectorAll("link[rel=import]"),b=a.length-1,c;0<=b&&(c=a[b]);b--){ this$1.g(c); }};h.prototype.g=function(b){b.__loaded||
(b.__loaded=!0,b.import&&(b.import.readyState="complete"),b.dispatchEvent(a(b.import?"load":"error",{bubbles:!1,cancelable:!1,detail:void 0})));};h.prototype.m=function(a){
var this$1 = this;
for(var b=0;b<a.length;b++){var c=a[b];if(c.addedNodes){ for(var d=0;d<c.addedNodes.length;d++){var e=c.addedNodes[d];e&&e.nodeType===Node.ELEMENT_NODE&&(g(e)?this$1.i(e):this$1.f(e));} }}};if(l){for(var A=document.querySelectorAll("link[rel=import]"),w=0,z=A.length,B;w<z&&(B=A[w]);w++){ B.import&&"loading"===B.import.readyState||(B.__loaded=
...
function(b,a){this.o.set(b,a);this.m.set(a.constructor,a);};p.prototype.f=function(b){return this.o.get(b)};p.prototype.L=function(b){return this.m.get(b)};p.prototype.s=function(b){this.i=!0;this.j.push(b);};p.prototype.l=function(b){var a=this;this.i&&t(b,function(b){return a.g(b)});};p.prototype.g=function(b){
var this$1 = this;
if(this.i&&!b.__CE_patched){b.__CE_patched=!0;for(var a=0;a<this.j.length;a++){ this$1.j[a](b); }}};p.prototype.b=function(b){
var this$1 = this;
var a=[];t(b,function(b){return a.push(b)});for(b=0;b<a.length;b++){var d=
a[b];1===d.__CE_state?this$1.connectedCallback(d):this$1.u(d);}};p.prototype.a=function(b){
var this$1 = this;
var a=[];t(b,function(b){return a.push(b)});for(b=0;b<a.length;b++){var d=a[b];1===d.__CE_state&&this$1.disconnectedCallback(d);}};p.prototype.c=function(b,a){
var this$1 = this;
a=a?a:new Set;var d=this,c=[];t(b,function(b){if("link"===b.localName&&"import"===b.getAttribute("rel")){var e=b.import;e instanceof Node&&"complete"===e.readyState?(e.__CE_isImportDocument=!0,e.__CE_hasRegistry=!0):b.addEventListener("load",function(){var c=
b.import;c.__CE_documentLoadHandled||(c.__CE_documentLoadHandled=!0,c.__CE_isImportDocument=!0,c.__CE_hasRegistry=!0,new Set(a),a.delete(c),d.c(c,a));});}else { c.push(b); }},a);if(this.i){ for(b=0;b<c.length;b++){ this$1.g(c[b]); } }for(b=0;b<c.length;b++){ this$1.u(c[b]); }};p.prototype.u=function(b){
var this$1 = this;
if(void 0===b.__CE_state){var a=this.f(b.localName);if(a){a.constructionStack.push(b);var d=a.constructor;try{try{if(new d!==b){ throw Error("The custom element constructor did not produce the element being upgraded."); }}finally{a.constructionStack.pop();}}catch(e){throw b.__CE_state=
2,e;}b.__CE_state=1;b.__CE_definition=a;if(a.attributeChangedCallback){ for(a=a.observedAttributes,d=0;d<a.length;d++){var c=a[d],f=b.getAttribute(c);null!==f&&this$1.attributeChangedCallback(b,c,null,f,null);} }g(b)&&this.connectedCallback(b);}}};p.prototype.connectedCallback=function(b){var a=b.__CE_definition;a.connectedCallback&&a.connectedCallback.call(b);};p.prototype.disconnectedCallback=function(b){var a=b.__CE_definition;a.disconnectedCallback&&a.disconnectedCallback.call(b);};p.prototype.attributeChangedCallback=
function(b,a,d,c,f){var e=b.__CE_definition;e.attributeChangedCallback&&-1<e.observedAttributes.indexOf(a)&&e.attributeChangedCallback.call(b,a,d,c,f);};F.prototype.f=function(){this.b&&this.b.disconnect();};F.prototype.g=function(b){
var this$1 = this;
var a=this.a.readyState;"interactive"!==a&&"complete"!==a||this.f();for(a=0;a<b.length;a++){ for(var d=b[a].addedNodes,c=0;c<d.length;c++){ this$1.c.c(d[c]); } }};T.prototype.c=function(){if(this.a){ throw Error("Already resolved."); }this.a=void 0;this.b&&this.b(void 0);};l.prototype.j=
